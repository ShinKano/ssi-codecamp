            ...
            <div className="container">
                ...
                <div className="columns is-centered margin-top">
                    <div className="column is-6">
                        <p>
                            24週間（6ヶ月間）のブートキャンプの前に語学留学期間を追加できます。ご自身の英語レベルによって留学期間、受講授業数をお選びいただけます。
                        </p>
                        <div className="margin-top-2" />
                        <p>
                            通常価格（6ヶ月間）約100万円のIT留学コースを、現在コロナ対策特別価格にてご用意しております。
                            6ヶ月という期間は、他社と比べても少し長い期間に思われるかもしれませんが、
